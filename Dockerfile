...
COPY --from=builder /go/src/github.com/cloud-barista/poc-cicd-spider/api-runtime/rest-runtime/admin-web/images/cb-spider-circle-logo.png /root/go/src/github.com/cloud-barista/poc-cicd-spider/api-runtime/rest-runtime/admin-web/images/
...
ENTRYPOINT [ "/root/go/src/github.com/cloud-barista/poc-cicd-spider/api-runtime/cb-spider" ]
